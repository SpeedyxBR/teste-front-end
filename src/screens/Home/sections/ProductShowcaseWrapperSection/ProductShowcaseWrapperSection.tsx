...
export const ProductShowcaseWrapperSection = (): JSX.Element => {
  ...
  if (loading) {
    return (
      <section className="w-full max-w-[1364px] mx-auto py-8" aria-label="Mais produtos">
  ...
  return (
    <>
      <section className="w-full max-w-[1364px] mx-auto py-8 px-4" aria-label="Mais produtos">
